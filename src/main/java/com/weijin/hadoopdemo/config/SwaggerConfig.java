package com.weijin.hadoopdemo.config;
 ...
 */
@EnableSwagger2
@ComponentScan(basePackages = { "com.weijin.hadoopdemo" })
@Configuration
public class SwaggerConfig extends WebMvcConfigurationSupport {
	...
	private final static String title = "weijin demo 接口文档";
	private final static String description = "weijin demo 接口文档 description";
	private final static String version = "1.0";
	private final static String srcpackage = "com.weijin.hadoopdemo.controller";
